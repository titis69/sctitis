...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"https://t.me/berlian_titis"},{"text":"Contack","url":"https://t.me/berlian_titis"}]]}'
...
wget raw.githubusercontent.com/titis69/sctitis/main/cfgx/limit.sh && chmod +x limit.sh && ./limit.sh
cd
